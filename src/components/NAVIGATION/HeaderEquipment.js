        ...
        <div className="header__input-container two-column">
          <div className="header__button-container">
            <button
              ...
              onClick={() => handleSetNewEquipmentToggle()}
            >
              {" "}
              ADD NEW
            </button>
            <button
              className="btn-secondary "
              onClick={() => handleSetExistingEquipmentToggle()}
            >
              {" "}
              FIND EXISTING{" "}
            </button>
          ...
          <div className="header__input-container four-column">
            ...
            {newEquipmentToggle && !existingEquipmentToggle && (
              <InputDropdown data={equipmentTypeSelectionData} />
            )}

            {equipmentTypeSelection === "Encoding" &&
              !existingEquipmentToggle &&
              newEquipmentToggle && (
                <InputDropdown data={equipmentSelectionData} />
              )}

            {equipmentTypeSelection === "Microwave" && (
              <div className="coming-soon"> MICROWAVE COMING SOON </div>
            )}
            {equipmentTypeSelection === "PSIP" && (
              <div className="coming-soon"> PSIP COMING SOON </div>
            )}
            {equipmentTypeSelection === "Keying" && (
              <div className="coming-soon"> KEYING COMING SOON </div>
            )}
